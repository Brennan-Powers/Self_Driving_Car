...
if __name__ == '__main__':
    ...
    while time.time() < stoptime:
        try:
            ...
            pyautogui.press('f6')
            time.sleep(1)
            with open("C:\\Program Files (x86)\\Steam\\steamapps\\common\\Grand Theft Auto V\\LiDAR GTA V\\LiDAR GTA V.cfg", 'w') as f:
                f.write(lidarcfg + str(count))
            #outputFile = "C:\\Users\\rwadams\\Documents\\output" + str(count) + ".ply"
            #send2file("C:\\Program Files (x86)\\Steam\\steamapps\\common\\Grand Theft Auto V\\LiDAR GTA V\\LiDAR_PointCloud.ply", outputFile)
            count += 1
            time.sleep(2)
            #print("just pressed")
